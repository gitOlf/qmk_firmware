...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER_1] = LAYOUT_split_3x5_2(
        ...
        KC_TILD,        KC_NO,           KC_UNDS,          KC_NO,             KC_RCBR,                          KC_RPRN, KC_PIPE, KC_BSPC,   KC_QUES,  KC_SLSH,
    ...
    [_LAYER_3] = LAYOUT_split_3x5_2(
        ...
        LGUI_T(KC_NO),   LALT_T(KC_F4),  LCTL_T(KC_F5),    LSFT_T(KC_F6),      KC_F11,                           KC_NO,    LSFT_T(KC_NO),     LCTL_T(KC_NO),    LALT_T(KC_NO),    LGUI_T(KC_NO),
        KC_NO,           KC_F7,          KC_F8,            KC_F9,              KC_F12,                           KC_NO,    KC_NO,             KC_NO,            KC_NO,            QK_BOOT,
                                                       KC_LSFT, LT(_LAYER_1, KC_BSPC),                           LT(_LAYER_2, KC_ENTER),      LCTL_T(KC_SPACE)
    )
};
